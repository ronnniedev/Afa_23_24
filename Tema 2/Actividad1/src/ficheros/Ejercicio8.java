...
public class Ejercicio8 {
	...
	/**
	 * Compara el primer numero y dice si este es mayor que el segundo
	 * @param num : entero
	 * @param numDos : entero
	 */
	...
	/**
	 * Nos indica si los tres numeros introducidos estan ordenados
	 * @param num : entero
	 * @param numDos : entero
	 * @param numTres : entero
	 */
	public static void ordenados (int num, int numDos , int numTres) {
		
		if (num > numDos && numDos > numTres || num < numDos && numDos < numTres)System.out.println("Estan ordenados");
