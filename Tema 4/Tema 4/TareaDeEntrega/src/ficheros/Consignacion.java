...
public class Consignacion {
	...
	/**
	 * Metodo set de numConsignaciones de la clase Consignacion
	 * @param numConsignaciones
	 */
	public static void setNumConsignaciones(int numConsignaciones) {
		Consignacion.numConsignaciones = numConsignaciones;
	}
