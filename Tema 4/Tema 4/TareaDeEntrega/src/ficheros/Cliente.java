...
public class Cliente extends Persona{
	 ...
	 * @param edad
	 */
	public Cliente(String nombre, String apellidos, String nif, int telefono, String correo
			, Genero genero,int edad) {
	...
	/**
	 * Metodo set para numCreaciones de clase Cliente
	 * @param numCreaciones
	 */
	public static void setNumCreaciones(int numCreaciones) {
		Cliente.numCreaciones = numCreaciones;
	}
