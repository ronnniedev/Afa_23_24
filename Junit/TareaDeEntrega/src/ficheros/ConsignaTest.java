...
class ConsignaTest {
	...
	public static void cargaDatos(Consigna con) {
		...
		Pruebas.anadirClientes(c1);
		Cliente c2 = new Cliente("Eric","Gonzalez", "348917289Ñ", 896432789,Genero.HOMBRE,36);
		Pruebas.anadirClientes(c2);
		Cliente c3 = new Cliente("Marisa","Meniscos", "372134678M", 985320654,"correoEstandar@gmail.com"
								,Genero.MUJER,17);
		Pruebas.anadirClientes(c3);
		con.anadirElementos(c1, 1,"Reloj diamantino,mochila skitty,Gafas recfacheras",3, "03/03/2024");
	...
	void testAñadirElementos() {
		...
		con.anadirElementos(c4, 1,"Reloj diamantino,mochila skitty,Gafas recfacheras",3, "03/03/2024");
