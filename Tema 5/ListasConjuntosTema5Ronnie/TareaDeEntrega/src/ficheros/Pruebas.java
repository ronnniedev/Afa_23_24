...
public class Pruebas {
	...
	public static void cargaDatos(Consigna con) {
		...
		con.añadirElementos(c1, 1,"Reloj diamantino,mochila skitty,Gafas recfacheras",3);
		con.añadirElementos(c2, 3,"Ordenador Gygabyte",1);
		con.añadirElementos(c3, 2,"Mochila portatil,chaqueta cara",2);
	...
	public static void prepararConsignacion(Consigna con) {
		...
		con.añadirElementos(localizarCliente(id),peso,descripcion,numObjetos);
